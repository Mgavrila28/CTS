...
public class VerificareTelefonTest {
	...
	public void setUp() throws Exception {
		reader = new FileReader("telefon.txt");
	...
	{
		System.out.println(" Verificare numar telefon  ");
		String linie = null;
		try {
			while((linie=bufferReader.readLine())!=null&&linie.length()!=0){
				...
				assertEquals("Erroare la "+rez+" cu "+str, rez,new Adult().NumarTelefonNumeric(str));
